...
.then(response => {
    ...
    fs.writeFileSync('src/images.json', JSON.stringify([]), 'utf8')
    fs.appendFile('src/images.json', JSON.stringify([]), 'utf8')
    
    
    

fs.readFile('src/images.json', 'utf8', function(err, jsonString) {
    if (err) {
    ...
    fs.writeFile('src/images.json', jsonString, 'utf8', function(err) {
        if (err) {
